...
export default function Signup() {
  ...
  return (
    <div className='container-fluid createvol'>
      <section className="text-white" >
  <div className="container h-80">
    <div className="row d-flex justify-content-center align-items-center h-100">
      <div className="col-lg-10 col-xl-11">
        <div className="card text-white" style={{borderRadius: "0px"}}>
              ...
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example4cd" className="form-control" name="geolocation" value={credentials.geolocation} onChange={onChange} placeholder='E.g Doctor/Patient/Helper' />
